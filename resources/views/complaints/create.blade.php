                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select form-select-lg @error('category_id') is-invalid @enderror" id="category_id" name="category_id" required>
                                    ...
                                    <option value="__other__" {{ old('category_id') == '__other__' ? 'selected' : '' }}>Community & Infrastructure</option>
                                    <option value="__other__" {{ old('category_id') == '__other__' ? 'selected' : '' }}>Environment & Public Health</option>
                                    <option value="__other__" {{ old('category_id') == '__other__' ? 'selected' : '' }}>Governance & Public Safety</option>
                                    <option value="__other__" {{ old('category_id') == '__other__' ? 'selected' : '' }}>Social Services</option>
                                    <option value="__other__" {{ old('category_id') == '__other__' ? 'selected' : '' }}>Administrative & Regulatory</option>
                                    <option value="__other__" {{ old('category_id') == '__other__' ? 'selected' : '' }}>other (please specify)</option>
                                </select>
                                @error('category_id')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
